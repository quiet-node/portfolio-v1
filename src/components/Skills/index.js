        ...
        <SkillsRow>
          ...
          <SkillsBarsWrapper data-aos="fade-left">
            <SkillsBar>
              ...
              <SkillsBarProgress>
                <SkillsBarHTML className="skillsBarHTML"></SkillsBarHTML>
              </SkillsBarProgress>
            ...
            <SkillsBar>
              ...
              <SkillsBarProgress>
                <SkillsBarCSS className="skillsBarCSS"></SkillsBarCSS>
              </SkillsBarProgress>
              <SkillsBarPercent>90%</SkillsBarPercent>
            </SkillsBar>
            <SkillsBar>
              ...
              <SkillsBarProgress>
                <SkillsBarReact className="skillsBarReact"></SkillsBarReact>
              </SkillsBarProgress>
            ...
            <SkillsBar>
              ...
              <SkillsBarProgress>
                <SkillsBarJS className="skillsBarJS"></SkillsBarJS>
              </SkillsBarProgress>
              <SkillsBarPercent>70%</SkillsBarPercent>
            </SkillsBar>
            <SkillsBar>
